// <copyright file="VideoProcessingServiceTests.cs" company="PlaceholderCompany">
...
namespace UnitTests.ReelsEditing
{
    ...
    {
        private Mock<IAudioLibraryService> mockAudioLibrary;
        ...
        public void SetUp()
        {
            this.mockAudioLibrary = new Mock<IAudioLibraryService>();
