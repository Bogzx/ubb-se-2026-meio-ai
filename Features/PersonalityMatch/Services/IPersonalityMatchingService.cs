...
namespace ubb_se_2026_meio_ai.Features.PersonalityMatch.Services
{
    ...
    public interface IPersonalityMatchingService
    {
        ...
        /// <returns>
        /// A <see cref="UserProfileModel"/> if found; otherwise <see langword="null"/>.
        /// </returns>
        ...
        /// <returns>
        /// A list of <see cref="MoviePreferenceDisplayModel"/> records ordered by score descending.
        /// </returns>
        Task<List<MoviePreferenceDisplayModel>> GetTopMoviePreferencesAsync(int userId, int topMoviePreferencesCount);
